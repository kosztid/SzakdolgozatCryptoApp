...
import com.example.crypto.security.models.Credentials;
...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    private void verifyToken(HttpServletRequest request) {
        ...
        FBUser user = firebaseTokenToUserDto(decodedToken);
        if (user != null) {
    ...
    private FBUser firebaseTokenToUserDto(FirebaseToken decodedToken) {
        FBUser user = null;
